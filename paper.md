...
The following comparison plots were generated by `metrics-analysis-project/analysis/compare_algorithms.py` and are available in the repository at `metrics-analysis-project/analysis/plots`.

<div style="display:flex; flex-wrap:wrap; gap:10px;">
   <div style="flex:0 0 32%; text-align:center;">
      <img src="metrics-analysis-project/analysis/plots/pair_dynamic_artistic.png" alt="pair_dynamic" style="width:100%; height:auto;"/>
      <p style="font-size:0.9em;">Pair: gt_dynamic vs gt_dynamic_adv</p>
   </div>
   <div style="flex:0 0 32%; text-align:center;">
      <img src="metrics-analysis-project/analysis/plots/pair_state_artistic.png" alt="pair_state" style="width:100%; height:auto;"/>
      <p style="font-size:0.9em;">Pair: gt_state vs gt_state_adv</p>
   </div>
   <div style="flex:0 0 32%; text-align:center;">
      <img src="metrics-analysis-project/analysis/plots/pair_combined_artistic.png" alt="pair_combined" style="width:100%; height:auto;"/>
      <p style="font-size:0.9em;">Pair: gt_state_dynamic vs gt_state_dynamic_adv</p>
   </div>
</div>

<div style="display:flex; flex-wrap:wrap; gap:10px; margin-top:12px;">
   <div style="flex:0 0 48%; text-align:center;">
      <img src="metrics-analysis-project/analysis/plots/triple_nonadv_artistic.png" alt="triple_nonadv" style="width:100%; height:auto;"/>
      <p style="font-size:0.9em;">Triple (non-adv): gt_dynamic, gt_state, gt_state_dynamic</p>
   </div>
   <div style="flex:0 0 48%; text-align:center;">
      <img src="metrics-analysis-project/analysis/plots/triple_adv_artistic.png" alt="triple_adv" style="width:100%; height:auto;"/>
...
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2CT/TC2CT_graph.png" alt="TC2CT K-core Decomposition" style="width: 100%; height: auto;"/>
<p style="font-size: 0.9em; margin-top: 5px;"><strong>(A) TC2CT</strong> - Direct thalamocortical to corticothalamic connectivity</p>
</div>
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2IT2PTCT/TC2IT2PTCT_kcore.png" alt="TC2IT2PTCT K-core Decomposition" style="width: 100%; height: auto;"/>
<p style="font-size: 0.9em; margin-top: 5px;"><strong>(B) TC2IT2PTCT</strong> - Complex multi-layer interactions</p>
</div>
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2IT4_IT2CT/TC2IT4_IT2CT_kcore.png" alt="TC2IT4_IT2CT K-core Decomposition" style="width: 100%; height: auto;"/>
<p style="font-size: 0.9em; margin-top: 5px;"><strong>(C) TC2IT4_IT2CT</strong> - Layer 4 intratelencephalic pathways</p>
</div>
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2PT/TC2PT_kcore.png" alt="TC2PT K-core Decomposition" style="width: 100%; height: auto;"/>
...
<img src="centrality/TC2PT/TC2PT_graph.png" alt="TC2PT Degree Centrality" style="width: 100%; height: auto;"/>
...
<div style="flex: 0 0 30%; text-align: center;">
<img src="centrality/TC2PT/TC2PT_t.png" alt="TC2PT Eigenvector Centrality" style="width: 100%; height: auto;"/>
...
<div style="flex: 0 0 30%; text-align: center;">
<img src="centrality/TC2PT/TC2PT_hitsX.png" alt="TC2PT HITS Authority" style="width: 100%; height: auto;"/>
<p style="font-size: 0.85em; margin-top: 5px;"><strong>(G) HITS Authority</strong> - Received importance</p>
</div>
<div style="flex: 0 0 30%; text-align: center;">
<img src="centrality/TC2PT/TC2PT_hitsY.png" alt="TC2PT HITS Hub" style="width: 100%; height: auto;"/>
<p style="font-size: 0.85em; margin-top: 5px;"><strong>(H) HITS Hub</strong> - Distributed importance</p>
</div>
<div style="flex: 0 0 30%; text-align: center;">
<img src="centrality/TC2PT/TC2PT_tt.png" alt="TC2PT EigenTrust Centrality" style="width: 100%; height: auto;"/>
...
<div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 10px;">
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2CT/TC2CT_graph.gif" alt="TC2CT Community Evolution" style="width: 100%; height: auto;"/>
<p style="font-size: 0.9em; margin-top: 5px;"><strong>(A) TC2CT</strong> - Direct thalamocortical connectivity</p>
</div>
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2IT2PTCT/TC2IT2PTCT_graph.gif" alt="TC2IT2PTCT Community Evolution" style="width: 100%; height: auto;"/>
<p style="font-size: 0.9em; margin-top: 5px;"><strong>(B) TC2IT2PTCT</strong> - Multi-layer interactions</p>
</div>
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2IT4_IT2CT/TC2IT4_IT2CT_graph.gif" alt="TC2IT4_IT2CT Community Evolution" style="width: 100%; height: auto;"/>
<p style="font-size: 0.9em; margin-top: 5px;"><strong>(C) TC2IT4_IT2CT</strong> - Layer 4 intratelencephalic pathways</p>
</div>
<div style="flex: 0 0 48%; text-align: center;">
<img src="centrality/TC2PT/TC2PT_graph.gif" alt="TC2PT Community Evolution" style="width: 100%; height: auto;"/>
